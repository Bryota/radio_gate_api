...
Route::get('/listener/unique_email', [ListenerController::class, 'isUniqueEmail']);
...
Route::group(['middleware' => 'auth:sanctum'], function () {
    ...
    Route::get('/radio_station/{id}/name', [RadioStationController::class, 'getRadioStationName']);
    ...
    Route::post('/saved_messages', [ListenerMessageController::class, 'save']);
    ...
    Route::post('/request_functions/{id}/point', [RequestFunctionController::class, 'submitListenerPoint']);
    Route::post('/inquery', [InqueryController::class, 'send']);
    Route::post('/developer_contact', [DeveloperContactController::class, 'send']);
});
...
Route::group(['prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::get('/radio_station/{id}/name', [AdminRadioStationController::class, 'getRadioStationName']);
    ...
    Route::post('/request_function_requests/{id}/close/', [AdminRequestFunctionRequestController::class, 'close']);
});
